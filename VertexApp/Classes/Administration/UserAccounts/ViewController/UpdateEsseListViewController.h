//
//  UpdateEsseListViewController.h
//  VertexApp
//
...
@interface UpdateEsseListViewController : UIViewController

@property (nonatomic, retain) NSMutableArray *updateEsseListPageEntries;
