//
//  ViewAssetTypePageViewController.h
//  VertexApp
//
...
@interface ViewAssetTypePageViewController : UIViewController

@property (nonatomic, retain) NSMutableArray *viewAssetTypePageEntries;
